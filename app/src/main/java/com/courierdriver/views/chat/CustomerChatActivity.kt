package com.courierdriver.views.chat
...
import com.courierdriver.adapters.BoatChatMessageListAdapter
import com.courierdriver.adapters.chat.MessageListAdapter
...
class CustomerChatActivity : BaseActivity(),
    ...
    */
    ...
    override fun initViews() {
        ...
        SocketConnectionManager.getInstance()
            .addEventListener("chatHistoryUser") { args ->
        ...
        SocketConnectionManager.getInstance()
            .addEventListener("newMessageUser") { args ->
                val data = args[0] as JSONObject
    ...
    override fun onConnected() {
        ...
        runOnUiThread {
            ...
            SocketConnectionManager.getInstance()
                .socket.emit("joinRoomUser", objectCreateRoom)
