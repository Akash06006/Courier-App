package com.example.courier.views.orders
...
import com.example.courier.adapters.orders.*
import com.example.courier.common.UtilsFunctions
import com.example.courier.constants.GlobalConstants
import com.example.courier.databinding.ActivityCreateOrderBinding
...
import com.example.saira.ShowToast
    ...
    private fun addAddressView(pickupAddress : OrdersDetailResponse.PickupAddress?) {
        ...
        imgDelContact?.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v : View?) {
                ...
                clickedForLocation = "other"
                if (UtilsFunctions.isNetworkConnected()) {
                    val intent1 = Intent(this@CreateOrderActivty, ContactListActivity::class.java)
        ...
        imgDelMap?.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v : View?) {
                ...
                clickedForLocation = "other"
                if (UtilsFunctions.isNetworkConnected()) {
                    val intent1 = Intent(this@CreateOrderActivty, AddAddressActivity::class.java)
